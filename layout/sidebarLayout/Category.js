        ...
        <li>
          ...
          <li>
            <a onClick={() => dispatch({ type: "propertyType", payload: "Stores" })}>
              <i className='fas fa-arrow-right me-2'></i>Stores <span className='float-end'>({value?.filter((x) => x.propertyType === "stores").length || 0})</span>
            </a>
          </li>
          <li>
            <a onClick={() => dispatch({ type: "propertyType", payload: "Farms" })}>
              <i className='fas fa-arrow-right me-2'></i>Farms <span className='float-end'>({value?.filter((x) => x.propertyType === "Farms").length || 0})</span>
            </a>
          </li>
          <li>
            <a onClick={() => dispatch({ type: "propertyType", payload: "Apartment" })}>
              <i className='fas fa-arrow-right me-2'></i>Apartment <span className='float-end'>({value?.filter((x) => x.propertyType === "apartment").length || 0})</span>
            </a>
          </li>
          <li>
            <a onClick={() => dispatch({ type: "propertyType", payload: "Villa" })}>
              <i className='fas fa-arrow-right me-2'></i>Villa <span className='float-end'>({value?.filter((x) => x.propertyType === "Villa").length || 0})</span>
            </a>
          </li>
          <li>
            <a onClick={() => dispatch({ type: "propertyType", payload: "Studio" })}>
              <i className='fas fa-arrow-right me-2'></i>Studio <span className='float-end'>({value?.filter((x) => x.propertyType === "studio").length || 0})</span>
            </a>
          </li>
          <li>
            <a onClick={() => dispatch({ type: "propertyType", payload: "Investment Projects" })}>
              <i className='fas fa-arrow-right me-2'></i>Investment Projects <span className='float-end'>({value?.filter((x) => x.propertyType === "Investment Projects").length || 0})</span>
            </a>
          </li>
        </ul>
      </div>
